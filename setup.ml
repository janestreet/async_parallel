(* OASIS_START *)
(* DO NOT EDIT (digest: f514b0b28d27ea51e169ec40d43a08bf) *)
(*
...
let setup_t =
  {
     ...
     test = [];
     doc = [("async_parallel", OCamlbuildDocPlugin.doc_build "lib")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("async_parallel", OCamlbuildDocPlugin.doc_clean "lib")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "examples";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "async_parallel"];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "camlp4o"];
                      bs_c_sources = [];
                      bs_data_files = [];
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_title = "Distributed computing library";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\210\t\247gG\140:\155\027\025\015\165\1672\138\014";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
