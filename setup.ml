(* OASIS_START *)
(* DO NOT EDIT (digest: cffdb3892cc7b3498a70cbf4d354254b) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/async_parallel";
          synopsis = "Distributed computing library";
          description =
            Some
              [
                 OASISText.Para
                   "Async_parallel is a library for running tasks in other processes on a cluster of machines.";
                 OASISText.Para
                   "It is deprecated: users should prefer Rpc_parallel, which has much fewer surprising edge-cases."
              ];
          categories = [];
          ...
          sections =
            [
               Library
                 ({
                     cs_name = "async_parallel_deprecated";
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "async_parallel";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [InternalLibrary "async_parallel_deprecated"];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "camlp4o"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {exec_custom = false; exec_main_is = "deep.ml"});
               Executable
                 ({
                     cs_name = "echo_server";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "pingpong.ml"});
               Executable
                 ({
                     cs_name = "ring";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "ring.ml"});
               Executable
                 ({
                     cs_name = "simple";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "wide.ml"})
            ];
          plugins =
            [
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\031`\004\159\235%bGj)\176\156\164\138K\250";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
