(* OASIS_START *)
(* DO NOT EDIT (digest: 4699c84b882b2b9307961dd932af9c12) *)
(*
...
let setup_t =
  {
     ...
     test = [];
     doc = [("parallel", OCamlbuildDocPlugin.doc_build "lib")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("parallel", OCamlbuildDocPlugin.doc_clean "lib")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
     ...
     oasis_version = "0.3.0";
     oasis_digest =
       Some "8\176\015\187\147\145\217\210\r\011x\177\183\170\214\210";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
